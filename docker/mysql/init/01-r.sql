...
) ENGINE = InnoDB AUTO_INCREMENT = 100 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '部门表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `sys_dict_type`  (
  ...
  UNIQUE INDEX `sys_dict_type_index`(`dict_type`) USING BTREE
